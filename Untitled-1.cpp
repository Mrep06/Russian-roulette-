    ...
    if(action == "CHALLENGE"){
        if(alive == 1){
            switch(player){
                ...
                wcout << L"X                   │──── │────   │ " << endl;
                wcout << L" X                     X  \\──│─│  │ " << endl;
                wcout << L"  X      XXXXXXX      X      X\\│  │ " << endl;
                wcout << L"   XX               XX       X │XX│ " << endl;
                ...
                case 2:
                    ...
                    wcout << L"X   X    X   X          X   X    X   X│────\\    │" << endl;
                    wcout << L"X   X    XXXXX          XXXXX    X   X      \\│  │" << endl;
                    wcout << L"XXXXX                            XXXXX       │  │" << endl;
                ...
                case 3:
                    ...
                    wcout << L"        X       X  │─────────────/" << endl;
                    wcout << L"       X         X │──── │────   │ " << endl;
                    wcout << L"     XX  O     O  XX     \\──│─│  │" << endl;
                    wcout << L"    X               X       X\\│  │" << endl;
                    wcout << L"   X      -----      X      X │XX│" << endl;
                    wcout << L" X                     X    X    X" << endl;
            ...
            switch(player){
                ...
                case 2:
                    ...
                    wcout << L"X   X    XXXXX          XXXXX XX      │─────────/ " << endl;
                    wcout << L"X   X    XXXXX          XXXXX X       │────\\    │" << endl;
                    wcout << L"X   X    XXXXX          XXXXX XX            \\│  │" << endl;
                    wcout << L"XXXXX                          XXX           │  │" << endl;
